...
public class AssignedNumber {
    ...
    static {
        ...
        sAssignedNumbers.put(0x181A, "Environmental Services");
        ...
        sAssignedNumbers.put(0x2A6D, "Pressure Measurement");
        sAssignedNumbers.put(0x2A6F, "Humidity Measurement");
        ...
        sAssignedNumbers.put(0x2A71, "Wind Direction");
